...
export default function() {
  ...
  for (let i = 0; i < 3; i += 1) {
    const res = http.get(`http://localhost:3001/player/artists/${i * 5 + 2000000}/albums`, {
  ...
  const url = `http://localhost:3001/player/artists/${Math.floor(Math.random() * 9999999) +
    1}/albums`;
  ...
  if (Math.floor(Math.random() * 1000) + 1 === 1000) {
    ...
    const postUrl = 'http://localhost:3001/player/album';
